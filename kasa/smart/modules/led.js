...
import { Led as LedInterface } from '../../interfaces/led.js';
...
export class Led extends SmartModule {
   ...
   */
  query() {
    return { [Led.QUERY_GETTER_NAME]: null };
  }
...
// Manually apply decorators since we can't use @allowUpdateAfter in standard JS
const setLedDescriptor = Object.getOwnPropertyDescriptor(Led.prototype, 'setLed');
if (setLedDescriptor) {
  Object.defineProperty(Led.prototype, 'setLed', allowUpdateAfter(Led.prototype, 'setLed', setLedDescriptor));
}
